  ...
  return (
    <form onSubmit={submit} className="rounded-lg border border-stone-300 bg-[#fbfaf6] p-5 shadow-sm">
      ...
      <label className="mt-4 flex items-start gap-3 text-sm leading-6 text-stone-700">
        ...
        <span>
          I agree to receive trip update SMS messages from Travel Map Dispatch (fewer than 5
          per week). Message and data rates may apply. Reply STOP to unsubscribe at any time.
          See the{" "}
